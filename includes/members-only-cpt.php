...
function members_only() {
	...
	$labels = array(
		...
		'parent_item_colon'     => __( 'Members Only Item:', 'members-only' ),
		'all_items'             => __( 'All Items', 'members-only' ),
		'add_new_item'          => __( 'Add New Item', 'members-only' ),
		'add_new'               => __( 'Add New', 'members-only' ),
		'new_item'              => __( 'New Item', 'members-only' ),
		'edit_item'             => __( 'Edit Item', 'members-only' ),
		'update_item'           => __( 'Update Item', 'members-only' ),
		'view_item'             => __( 'View Item', 'members-only' ),
		'search_items'          => __( 'Search Item', 'members-only' ),
		...
		'items_list'            => __( 'Items list', 'members-only' ),
		'items_list_navigation' => __( 'Items list navigation', 'members-only' ),
		'filter_items_list'     => __( 'Filter items list', 'members-only' ),
	);
	$args = array(
