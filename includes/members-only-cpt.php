...
function members_only() {
	...
	$labels = array(
		...
		'archives'              => __( 'Content Archives', 'members-only' ),
		'parent_item_colon'     => __( 'Parent Content:', 'members-only' ),
		...
		'insert_into_item'      => __( 'Insert into content', 'members-only' ),
		'uploaded_to_this_item' => __( 'Uploaded to this content', 'members-only' ),
	...
	$args = array(
		...
		'description'           => __( 'Separate your members content from the rest of your site', 'members-only' ),
		'labels'                => $labels,
